...
@Composable
fun ShopCategoriesDropdownMenu(
    expanded: Boolean,
    placeholder: String,
    items: List<ShopCategory>,
    selectedItems: List<ShopCategory>,
    onExpandChange: () -> Unit,
    onSelectItem: (ShopCategory) -> Unit,
...
private fun EShopDropdownMenuPreview() {
    ...
    EShopTheme {
        ShopCategoriesDropdownMenu(
            false,
            stringResource(id = com.eshop.signup_presentation.R.string.select_your_shop_categories),
            ShopCategory.listAllCategories(),
            emptyList(),
            {},
            {},
