...
import com.eshop.signup_presentation.signup.util.ShopData

@Composable
fun ShopDataBox(
    shopData: ShopData,
    onExitClick: (ShopData) -> Unit,
    ...
    Surface(
        ...
        Row(
            ...
            Text(
                text = shopData.value, fontFamily = PoppinsFontFamily,
...
private fun SellerCategoryBoxPreview() {
    EShopTheme {
        ShopDataBox(shopData = ShopCategory.ArtAndCraft, onExitClick = {})
    }
}